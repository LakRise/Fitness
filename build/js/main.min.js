...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/swiper-feedback.js":11,"./modules/swiper-jury.js":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var setSwiperJury = exports.setSwiperJury = function setSwiperJury() {
  var swiperJury = new Swiper(jury, {
    direction: 'horizontal',
    loop: true,
    slidesPerView: 'auto',
    autoHeight: false,
